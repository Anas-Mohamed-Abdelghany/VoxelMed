...
export default function LandingScreen() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center">
      <div className="flex flex-col items-center gap-6 p-12 rounded-2xl bg-med-panel border border-med-border shadow-2xl">
        <div className="w-20 h-20 rounded-full bg-med-accent/10 flex items-center justify-center">
          <svg className="w-10 h-10 text-med-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold mb-1">VoxelMed</h1>
          <p className="text-med-text-dim text-sm">3D Medical Image Viewer</p>
        </div>
        <button
          onClick={() => fileRef.current?.click()}
          className="px-6 py-3 bg-med-accent hover:bg-med-accent-hover rounded-lg font-medium transition-colors"
        >
